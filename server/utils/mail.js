    ...
    <div style="display: block; margin: auto; max-width: 600px" class="main">
     <div style="width: 100%">
      ...
      <div>
        ...
        <p style="color: #dd40b3; font-weight: 700; margin-top: 24px; margin-bottom: 6px">You've won a <span style="text-transform: capitalize;"> ${user.swag}</span></p>
      ...
      <div style="border-top: 1px solid #e0e3e9; margin-top: 24px">
        ...
        <div style="display: flex; justify-content: center">
          <div style="border-top: 1px solid #6e7a91; width: 10px"></div>
        </div>
